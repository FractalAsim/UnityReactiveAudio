...
//modified to include Pattern Texture

Shader "Standard_SoundBufferColor"
{
    Properties
    {
		...
		//Custom
		_PatternTex(" Pattern Texture (R)", 2D) = "black" {}
			...
			#include "UnityStandardConfig.cginc"
				...
				#include "UnityStandardCore.cginc"
					...
					half4 fragBase(VertexOutputForwardBase i) : SV_Target
					{
						...
						fixed pattern = tex2D(_PatternTex, i.tex.xy).r;
						...
						fixed snd = (tex2D(_SoundBufferTex, float2((0 - pattern), 0)).r * _AmpScale * nullTestResult);

						return fragForwardBaseInternal(i) + snd;
					}
